...
fileDir = 'Masters Simulations/Sensorimotor/';
fileLoad = 'J_Sensorimotor';
fileSave = 'Ising_Phi_Sensorimotor.mat';
...
%                 mag = mag + 2*spin_vec(Flip);
        ...
        for jj = 1:timeCorr;
            ...
            S(:,jj,b,count)=spin_vec;
        end
        
        Corr_DTI(:,:,b,count)=corrcoef(squeeze(S(:,:,b,count))');
